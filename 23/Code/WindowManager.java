...
//            drawComponent(window.getMinimizeButton()); //use attributes/coordinates to draw
    ...
    public void fillComponent(RATwidget Comp) {
        super.fillRect(
                Comp.getsX(),
                Comp.getsY(),
                Comp.geteX(),
    ...
    public void drawComponent(RATwidget Comp) {
        super.drawRect(
                Comp.getsX(),
                Comp.getsY(),
                Comp.geteX(),
    ...
    public boolean isInsideComponent(int x, int y, RATwidget comp) {
